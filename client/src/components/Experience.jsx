...
const JOBS = [
  {
    ...
    bullets: [
      'Built and shipped foundational UI modules in a production React application.',
      'Wrote unit and integration tests with Jest and React Testing Library.',
      'Participated in daily standups, sprint planning, and code reviews in an Agile team.',
    ],
  ...
  },
  {
    ...
    bullets: [
      'Delivered key feature modules for a production SaaS product.',
      'Built responsive UIs with React, Next.js, and Tailwind CSS.',
      'Integrated third-party REST APIs and authentication flows.',
      'Worked closely with the team to translate requirements into clean implementations.',
    ],
    metrics: ['Feature delivery', 'Responsive UI', 'API integrations'],
  },
  {
    ...
    bullets: [
      'Leading development of AFX DSO and AFX Digital Signature across enterprise workflows.',
      'Architected offline-first React Native experiences with real-time sync and resilient background handling.',
      'Improved backend response times through query optimization, caching, and connection pooling.',
      'Collaborated with cross-functional teams to deliver scalable features on time.',
    ],
    metrics: ['Enterprise apps', '40% faster API', '3 regions'],
  },
  {
